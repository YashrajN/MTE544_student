...
from planner import POINT_PLANNER, TRAJECTORY_PLANNER, ASTAR_PLANNER, PRM_PLANNER, planner
...
class decision_maker(Node):
    ...
    def __init__(self, publisher_msg, publishing_topic, qos_publisher, rate=10, motion_type=POINT_PLANNER):
        ...
        # this can be useful if you are having issues using the mapPublisher with Rviz
